...
urlpatterns = patterns('',
    ...
    url(r'^partials/myJob', 'tgn.views.myJob'),
    url(r'^partials/jobApplicants', 'tgn.views.jobApplicants'),
    url(r'^partials/searchResults', 'tgn.views.searchResults'),
    url(r'^tgn/api/loginWithFacebook', 'tgn.api.loginWithFacebook'),
    url(r'^tgn/api/postJobAsNonprofit', 'tgn.api.postJobAsNonprofit'),
